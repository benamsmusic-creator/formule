      ...
      <div className="max-w-xl mx-auto px-5 sm:px-6">
        ...
        {!loaded ? <SkeletonRows count={5} /> : list.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-16 text-center">
            ...
            <h2 className="text-2xl font-light text-brown-700 mb-1" style={{ fontFamily: 'var(--font-cormorant)' }}>Aucune enchère</h2>
            <p className="text-brown-400 text-sm max-w-xs mx-auto">Créez votre premier honneur à enchérir à l’aide du formulaire ci-dessus.</p>
          </div>
        ) : (
