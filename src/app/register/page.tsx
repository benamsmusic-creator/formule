...
export default function RegisterPage() {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center px-6 bg-beige-50 overflow-y-auto py-10">
      <motion.div
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-brown-400 text-sm">Créez votre compte pour gérer vos réservations</p>
        </div>
        ...
        >
          ...
          <div className="space-y-4 mb-6">
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="block text-xs text-brown-500 uppercase tracking-widest font-medium mb-2">Prénom</label>
                <input
                  autoFocus
                  className="w-full px-4 py-3 rounded-xl bg-beige-100 border border-beige-200 text-brown-900 text-sm focus:outline-none focus:border-gold-400 transition-colors"
                  placeholder="Prénom"
                  value={firstName}
              ...
              <div>
                <label className="block text-xs text-brown-500 uppercase tracking-widest font-medium mb-2">Nom</label>
                <input
                  className="w-full px-4 py-3 rounded-xl bg-beige-100 border border-beige-200 text-brown-900 text-sm focus:outline-none focus:border-gold-400 transition-colors"
                  placeholder="Nom"
                  value={lastName}
            ...
            <div>
              <label className="block text-xs text-brown-500 uppercase tracking-widest font-medium mb-2">Confirmer le mot de passe</label>
              <input
                type="password"
                className="w-full px-4 py-3.5 rounded-xl bg-beige-100 border border-beige-200 text-brown-900 text-base focus:outline-none focus:border-gold-400 transition-colors"
                placeholder="••••••••"
          ...
          <p className="text-center text-xs text-brown-400 mt-5">
            Déjà un compte ?{' '}
            <Link href="/user-login" className="text-gold-600 hover:text-gold-500 font-medium transition-colors">
              Se connecter
            </Link>
          </p>
        </motion.form>
