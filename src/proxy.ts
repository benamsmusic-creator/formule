...
const PROTECTED = ['/dashboard', '/builder', '/clients', '/parametres', '/newsletter', '/yahrzeit', '/annuaire', '/annonces', '/anniversaires', '/historique', '/membres', '/plan', '/encheres', '/sms'];
...
export const config = {
  matcher: ['/dashboard/:path*', '/builder/:path*', '/clients/:path*', '/parametres/:path*', '/newsletter/:path*', '/yahrzeit/:path*', '/annuaire/:path*', '/annonces/:path*', '/anniversaires/:path*', '/historique/:path*', '/membres/:path*', '/plan/:path*', '/encheres/:path*', '/sms/:path*'],
};
