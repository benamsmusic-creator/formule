...
const PROTECTED = ['/dashboard', '/builder', '/clients', '/parametres', '/newsletter', '/yahrzeit'];
...
export const config = {
  matcher: ['/dashboard/:path*', '/builder/:path*', '/clients/:path*', '/parametres/:path*', '/newsletter/:path*', '/yahrzeit/:path*'],
};
